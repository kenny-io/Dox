  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        muted: 'hsl(var(--dox-muted) / <alpha-value>)',
        border: 'hsl(var(--dox-border) / <alpha-value>)',
        accent: 'hsl(var(--dox-accent) / <alpha-value>)',
        'accent-foreground': 'hsl(var(--dox-accent-foreground) / <alpha-value>)',
        ring: 'hsl(var(--dox-ring) / <alpha-value>)',
      },
      boxShadow: {
